...
<ImageGallery
  images={[
    { src: '/projects/petsrs/pets1.webp', alt: 'Presentation of the state plan for animal disaster response, part of the Plano Rio Grande' },
    { src: '/projects/petsrs/pets2.webp', alt: 'Meeting with the Rio Grande do Sul animal response team' },
  ]}
/>
